...
Public Class admin
    ...
    Sub getAdmin()
        Try
            ...
            Dim url As String = "http://localhost:1323/api/admin/get"
                ...
                Using responseStream As Stream = response.GetResponseStream()
                    Using reader As New StreamReader(responseStream)
                        ...
                        For Each item As Object In dict
                            DataGridView1.Rows.Add(i, item("id_admin").ToString(),
                                item("nama").ToString(),
    ...
    Private Sub btn_insert_Click(sender As Object, e As EventArgs) Handles btn_insert.Click
        ...
        'untuk memanggil fungsi menampilkan data baru'
        SaveData(nama, username, password)



    End Sub
    Private Sub SaveData(nama As String, username As String, password As String)
        Try

            Dim requestData As New Dictionary(Of String, String)()
            requestData.Add("nama", nama)
            requestData.Add("username", username)
            requestData.Add("pass", password)

            ' Ubah data permintaan menjadi JSON
            Dim jsonRequestData As String = JsonConvert.SerializeObject(requestData)

            'url API localhost'
            Dim apiUrl As String = "http://localhost:1323/api/admin/post/" & nama & "/" & username & "/" & password
    ...
    Private Sub UpdateData(id As String, nama As String, username As String, password As String)
        Try
            ...
            Dim apiUrl As String = "http://localhost:1323/api/admin/put/" & id & "/" & nama & "/" & username & "/" & password
    ...
    Private Sub btn_update_Click(sender As Object, e As EventArgs) Handles btn_update.Click
        ...
        Dim username As String = txt_username.Text
        Dim password As String = txt_pass.Text
        UpdateData(id, nama, username, password)
    ...
    Private Sub DeleteData(id As String)
        Try
            ' url API localhost
            Dim apiUrl As String = "http://localhost:1323/api/admin/delete/" & id
    ...
    Private Sub DataGridView1_CellMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles DataGridView1.CellMouseClick
        ...
        txt_username.Text = DataGridView1.Rows(e.RowIndex).Cells(3).Value
        txt_pass.Text = DataGridView1.Rows(e.RowIndex).Cells(4).Value
    End Sub
End Class